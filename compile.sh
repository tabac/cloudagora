...
######### Compile Cloudagora Contracts ####################

solc --abi --optimize --overwrite --bin -o ../build cloudagora/UsersRegistry.sol
solc --abi --optimize --overwrite --bin -o ../build cloudagora/AgoraContract.sol
solc --abi --optimize --overwrite --bin -o ../build --allow-paths /cloudagora, cloudagora/auction/AuctionFactory.sol
